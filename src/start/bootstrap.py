...
class VespaBootstrapper():   
    ...
    def bootstrap(self):
        ...
        (self.vespaPrefs, self.vespaXMLOpts, self.runOpts, self.networkingOpts) = self.vespaConfig.getAll()
        ...
        self.vespaXML = vespaconfig.produceVespaXML(self.vespaXMLOpts, self.networkingOpts, self.masterXML)
